...
export async function getPokemonsData(getPokemons, POKEMONS_PER_PAGE, pageIndex) {
...
export async function getPokemonData(getPokemon, getSpecies, getSprite, selectedPokemon) {
